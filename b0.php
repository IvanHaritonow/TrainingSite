...
if (isset($_POST['tel']))			{$sab			= $_POST['tel1'];		if ($tel1 == '')		{unset($tel1);}}
...
echo "<p style='color:#eee;'>Уважаемый(ая) <b>$name1</b> Ваше письмо отправленно успешно. <br> Спасибо. <br>Вам скоро ответят на почту <b> $email1</b>.</p>";
}
